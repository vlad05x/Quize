...
const questions = [
  ...
  {
    title: "Какой социальной сетью я пользуюсь чаще всего?",
    variants: ["Instagram", "Linkedin", "Twich", "TikTok"],
    correct: 3,
  },
  {
  ...
  {
    title: "Какой фильм я предпочитаю?",
    variants: ["Фантастика", "Комедия", "Боевик", "Драма"],
    correct: 2,
  },
  {
    title: "Какой автомобиль я бы выбрал?",
    variants: ["BMW", "Mersedes", "Tesla", "Rolse-Roise"],
    correct: 1,
  },
  {
    title: "В какой стране я бы хотел побывать ?",
    variants: ["Америка", "Польша", "Китай", "Испания"],
    correct: 0,
  },
  {
    title: "Какой стиль одежды мне ближе всего ?",
    variants: ["Спотривный", "Классический", "Шо попало", "Домашний"],
    correct: 0,
  },
];
